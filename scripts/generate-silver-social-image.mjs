...
const image = new ImageResponse(
  box({ width: 1200, height: 630, background: '#f6f5e9', color: '#254f40', position: 'relative' },
    ...
    box({ position: 'absolute', top: 386, left: 62, fontSize: 23, fontWeight: 700 }, 'FUE REPROGRAMADO'),
    box({ position: 'absolute', top: 434, left: 60, padding: '12px 21px', borderRadius: 30, background: '#e7eea3', fontSize: 25, fontWeight: 700 }, 'SÁBADO 17 DE OCTUBRE'),
