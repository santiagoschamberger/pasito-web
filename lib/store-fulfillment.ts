export const PICKUP_LABEL = 'Retiro en Belgrano'
export const PICKUP_NOTE = 'Coordinamos el punto exacto y horario después de la compra'
export const PICKUP_CONFIRMATION = 'Escribinos por WhatsApp para coordinar el punto exacto en Belgrano, el día y el horario de retiro.'
...
export function pickupWhatsAppUrl(customerName?: string | null) {
  const message = [
    ...
    'Voy a pasar por Belgrano a buscar mi remera el [DÍA] a las [HORA].',
  ].join(' ')
